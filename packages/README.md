...
- `Packages` - Package index (plain text, auto-generated and committed)
- `Packages.gz` - Compressed package index (auto-generated and committed)
...
These index files are automatically generated by GitHub Actions and committed to the main branch for serving via GitHub Pages.
